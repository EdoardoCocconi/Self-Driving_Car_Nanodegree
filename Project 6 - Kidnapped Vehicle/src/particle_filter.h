...
public:
     ...
     * @param gps_x Initial gps_x position [m] (simulated estimate from GPS)
     * @param gps_y Initial gps_y position [m]
     * @param gps_theta Initial orientation [rad]
     * @param std[] Array of dimension 3 [standard deviation of gps_x [m],
     *   standard deviation of gps_y [m], standard deviation of yaw [rad]]
     */
    void init(double gps_x, double gps_y, double gps_theta, double std[]);
